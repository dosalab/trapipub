...
urlpatterns = [
    ...
    url(r'^carriers/$',views.GetCarriersView.as_view({'get':'list'}),name='get_carriers'),
    url(r'^carrier/(?P<id>[0-9]+)/?$',views.GetCarrierDetailsView.as_view({'get':'retrieve'}), name='carrierdetail'),
